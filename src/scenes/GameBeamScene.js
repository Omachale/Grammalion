...
export default class GameBeamScene extends Phaser.Scene {
  constructor() {
    super({ key: 'GameBeamScene' });
  }
  ...
  create() {
    ...
    // ── Layer 1: Static home-screen background (always visible) ───────────────
      ...
      this.tweens.add({
        ...
        onComplete: () => {
          ...
          this.tweens.add({
            ...
            ease:     'Sine.easeOut',
            onComplete: () => {
              // ── Phase 4: Crossfade Display → Display4 ───────────────────
  ...
  _startDisplaySequence() {
    ...
    // ── Transition: Display → Display4 (0.3s) ────────────────────────────────
    this._beamNext.setTexture('display4').setScale(scaleX, scaleY).setAlpha(0);
